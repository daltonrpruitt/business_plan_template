...
\begin{document}
% I. COVER SHEET
% • Name, address, company phone number ( if not
% sure list proposed address and your personal
% information
% • Name, title, address, phone number of owners
% • Month and year the plan was prepared
% • Name of preparer of those who assisted (if not
% owner)
% • NOTE: You may want to add a confidentiality statement
% as a footer to all pages.
\begin{titlepage}
    \centering
    \maketitle
